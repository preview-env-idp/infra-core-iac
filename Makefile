...
.PHONY: help bootstrap-pve check-bootstrap-pve

help:
	@echo "Available targets:"
	@echo "  help                - Show this help message"
	@echo "  bootstrap-pve       - Bootstrap Proxmox VE"
	@echo "  check-bootstrap-pve - Dry-run (check mode) for Bootstrap Proxmox VE"

# Day-0: Proxmox hardening and DevBox provisioning
bootstrap-pve:
...
check-bootstrap-pve:
	...
	@echo "DRY RUN: Checking hypervisor hardening and DevBox creation on $(PVE_NODE_01_IP)..."
